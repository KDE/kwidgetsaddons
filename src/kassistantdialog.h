...
public:
...
#if KWIDGETSADDONS_ENABLE_DEPRECATED_SINCE(6, 28)
    /*!
     ...
     */
    KWIDGETSADDONS_DEPRECATED_VERSION(6, 28, "Override next or use setValid instead")
     ...
     */
    KWIDGETSADDONS_DEPRECATED_VERSION(6, 28, "Override back instead")
