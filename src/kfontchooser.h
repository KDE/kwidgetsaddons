...
public:
     ...
     *
     * @deprecated since 5.85, use the KFontChooser(KFontChooser::DisplayFlags, QWidget*) constructor
     ...
     *
     * @deprecated Since 5.85, for lack of usage.
     */
    KWIDGETSADDONS_DEPRECATED_VERSION(5, 85, "For lack of usage.")
     ...
     *
     * @deprecated since 5.85, use createFontList(uint) instead.
     */
    KWIDGETSADDONS_DEPRECATED_VERSION(5, 85, "Use KFontChooser::createFontList(uint) instead.")
